...
| [Applied Energistics 2](https://www.curseforge.com/minecraft/mc-mods/applied-energistics-2) | 1.16.5/8.4.0-alpha.2 | | A Mod about Matter, Energy and using them to conquer the world.  | ❌ | ✔️ | ❌ |
| [AstralSorcery](https://www.curseforge.com/minecraft/mc-mods/astral-sorcery) | 1.16.5/1.13.10 | | Astral Sorcery is a magic mod focused around harnessing the powers of starlight and the constellations. | ✔️ | ❌ | ❌ |
| [AutoRegLib](https://www.curseforge.com/minecraft/mc-mods/autoreglib) | 1.16.5/1.6-47 | This is a simple library for Vazkii's mods. It automates annoying parts of modding, like registering items, blocks, or models. It also features a packet system and a bunch of random shared utils. | ✔️ | ✔️ | ❌ |
| [Biomes O' Plenty](https://www.curseforge.com/minecraft/mc-mods/biomes-o-plenty) | 1.16.5/13.0.0.468 | | Biomes O' Plenty is an expansive biome mod for Minecraft that adds a slew of new, unique biomes to the Overworld and Nether!  To go along with the new biomes, it adds new plants, flowers, trees, building blocks, and much more! | ✔️ | ✔️ | ❌ |
| [Clumps](https://www.curseforge.com/minecraft/mc-mods/clumps) | 1.16.5/6.0.0.23 | | Clumps groups XP orbs together into a single entity to reduce lag when there are many in a small area. Ontop of this, it also makes the player immediately collect the orbs once they touch the player, so you are not stuck with a bunch of orbs in your face. | ✔️ | ✔️ | ✔️ |
...
| [Curios API](https://www.curseforge.com/minecraft/mc-mods/curios) | 1.16.5/4.0.5.1 | | Curios is a flexible and expandable accessory/equipment API for users and developers. The purpose is to provide functionality for developers to add extra accessory/equipment slots in a convenient and compatible manner, as well as to give users the ability to configure these slots to their preferences. By default, Curios does not add any content except for an inventory GUI. There are no slots and only two items, the latter only being available through the Creative menu and primarily serving as examples for developers to use when coding their own integration. | ✔️ | ✔️ | ❌ |
...
| [Just Enough Items (JEI)](https://www.curseforge.com/minecraft/mc-mods/jei) | 1.16.5/7.7.0.99 | | JEI is an item and recipe viewing mod for Minecraft, built from the ground up for stability and performance. | ✔️ | ✔️ | ❌ |
| [JourneyMap](https://www.curseforge.com/minecraft/mc-mods/journeymap) | 1.16.5/5.7.1 | | Real-time mapping in game or in a web browser as you explore.  | ❌ | ❌ | ❌ |
| [Mantle](https://www.curseforge.com/minecraft/mc-mods/mantle) | [785bcbf544651db7a5e9a3c73a5999c10b44aab3](https://github.com/SlimeKnights/Mantle/tree/785bcbf544651db7a5e9a3c73a5999c10b44aab3) | [Check](https://github.com/SlimeKnights/Mantle/compare/785bcbf544651db7a5e9a3c73a5999c10b44aab3...1.16) |  This contains shared code for Forge mods and is used by the Slime Knights. Descriptive book code and common inventories are found here. | ✔️ | ✔️ | ❌ |
...
| [ObserverLib](https://www.curseforge.com/minecraft/mc-mods/observerlib) | 1.16.4/1.5.2 | | ObserverLib is a library mod, usable to reliably observe block changes in a potentially large area with very little performance implications. | ✔️ | ❌ | ❌ |
...
| [Quark](https://www.curseforge.com/minecraft/mc-mods/quark) | 1.16.5/r2.4-311 | | Quark is a fully modular mod with the objective of improving the vanilla gameplay experience. In other words, I would call it "what I would add if I was hired at mojang - the mod". Modules can be turned off and all features can be turned off individually. Some even have more in-depth configs. | ❌ | ✔️ | ❌ |
| [Simple Backpacks](https://github.com/shroomdog27/SimpleBackpacks) | [f11379d7a695d3c91a0d5a33714f38760010f11e](https://github.com/shroomdog27/SimpleBackpacks/tree/f11379d7a695d3c91a0d5a33714f38760010f11e) | [Check](https://github.com/shroomdog27/SimpleBackpacks/compare/f11379d7a695d3c91a0d5a33714f38760010f11e...1.16.x)| Adds simple, tiered backpacks. | ✔️ | ✔️ | ✔️ |
...
| [SuperMartijn642's Core Lib](https://www.curseforge.com/minecraft/mc-mods/supermartijn642s-core-lib) | 1.16.5/1.0.3 | | SuperMartijn642's Core Lib adds lots of basic implementations for guis that allow for similar code between Minecraft 1.12, 1.14, 1.15, and 1.16! | ✔️ | ✔️ | ✔️ |
| [Supplementaries](https://www.curseforge.com/minecraft/mc-mods/supplementaries) | 1.16.5/0.12.2 | | Supplementaries adds many animated and functional decorations and redstone blocks that fit in well with vanilla Minecraft. | ❌ | ✔️ | ✔️ |
| [Tinkers' Construct](https://www.curseforge.com/minecraft/mc-mods/tinkers-construct/) | [ba5a65ba8e15c4d1b222cfec10ab2a2d0a3a7d3b](https://github.com/SlimeKnights/TinkersConstruct/tree/ba5a65ba8e15c4d1b222cfec10ab2a2d0a3a7d3b) | [Check](https://github.com/SlimeKnights/TinkersConstruct/compare/ba5a65ba8e15c4d1b222cfec10ab2a2d0a3a7d3b...1.16) | Tinkers' Construct is a mod about putting tools together in a wide variety of ways, then modifying them until they turn into something else. The tools never disappear and can be named and changed to your heart's desire. Once you make them, they're yours forever. Many different materials can be used to make your tools. | ✔️ | ✔️ | ❌ |
...
| [The Twilight Forest](https://www.curseforge.com/minecraft/mc-mods/the-twilight-forest) | [7e0615f49970437dc7857ddca9f63cb6b7ddac4d](https://github.com/TeamTwilight/twilightforest/tree/7e0615f49970437dc7857ddca9f63cb6b7ddac4d) | [Check](https://github.com/TeamTwilight/twilightforest/compare/7e0615f49970437dc7857ddca9f63cb6b7ddac4d...1.16.x) | Twilight Forest is a dimension exploration mod focused on adventure that will take you on a journey to meet strange creatures, exploring dungeons, and much more. | ✔️ | ❌ | ❌ |
| [Waystones](https://www.curseforge.com/minecraft/mc-mods/waystones) | 1.16.5/7.5.1 | | This mod adds waystone blocks that the player can return to once they've been activated, either through a Warp Scroll, a rechargeable Warp Stone, or by using an existing waystone to hop from one to the other. | ✔️ | ✔️ | ❌ |
