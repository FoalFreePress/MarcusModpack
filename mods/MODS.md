...
| [Applied Energistics 2](https://www.curseforge.com/minecraft/mc-mods/applied-energistics-2) | 1.16.5/8.3.0-beta.2 | | A Mod about Matter, Energy and using them to conquer the world.  | ❌ | ✔️ | ❌ |
| [AstralSorcery](https://www.curseforge.com/minecraft/mc-mods/astral-sorcery) | 1.16.4/1.13.9 | | Astral Sorcery is a magic mod focused around harnessing the powers of starlight and the constellations. | ✔️ | ❌ | ❌ |
| [Biomes O' Plenty](https://www.curseforge.com/minecraft/mc-mods/biomes-o-plenty) | 1.16.5/13.0.0.458 | | Biomes O' Plenty is an expansive biome mod for Minecraft that adds a slew of new, unique biomes to the Overworld and Nether!  To go along with the new biomes, it adds new plants, flowers, trees, building blocks, and much more! | ✔️ | ✔️ | ❌ |
| [Clumps](https://www.curseforge.com/minecraft/mc-mods/clumps) | 1.16.5/6.0.0.22 | | Clumps groups XP orbs together into a single entity to reduce lag when there are many in a small area. Ontop of this, it also makes the player immediately collect the orbs once they touch the player, so you are not stuck with a bunch of orbs in your face. | ✔️ | ✔️ | ✔️ |
...
| [Just Enough Items (JEI)](https://www.curseforge.com/minecraft/mc-mods/jei) | 1.16.5/7.6.4.87 | | JEI is an item and recipe viewing mod for Minecraft, built from the ground up for stability and performance. | ✔️ | ✔️ | ❌ |
...
| [Mantle](https://www.curseforge.com/minecraft/mc-mods/mantle) | 1.16.5/1.6.92 | [Check](https://github.com/SlimeKnights/Mantle/compare/95ff3afd5190c75e6c0c948b7fd6a311227d4ad9...1.16) |  This contains shared code for Forge mods and is used by the Slime Knights. Descriptive book code and common inventories are found here. | ✔️ | ✔️ | ❌ |
...
| [Moving Elevators](https://www.curseforge.com/minecraft/mc-mods/moving-elevators) | 1.16.5/1.2.33 | | Moving Elevators allows you to build real moving elevators! These elevator will move you as well as other entities on the platform to multiple floors at the press of a button! The platform can have different sizes and can move at different speeds! You can even disguise the Elevator Controller and Display as other blocks! | ✔️ | ✔️ | ✔️ |
...
| [ObserverLib](https://www.curseforge.com/minecraft/mc-mods/observerlib) | 1.16.4/1.5.1 | | ObserverLib is a library mod, usable to reliably observe block changes in a potentially large area with very little performance implications. | ✔️ | ❌ | ❌ |
...
| [Supplementaries](https://www.curseforge.com/minecraft/mc-mods/supplementaries) | 1.16.5/0.12.1 | | Supplementaries adds many animated and functional decorations and redstone blocks that fit in well with vanilla Minecraft. | ❌ | ✔️ | ✔️ |
| [Tinkers' Construct](https://www.curseforge.com/minecraft/mc-mods/tinkers-construct/) | [a4161f0](https://github.com/SlimeKnights/TinkersConstruct/tree/a4161f0d2dd9689801675f6ff5b97c3dd13e3b8c) | [Check](https://github.com/SlimeKnights/TinkersConstruct/compare/a4161f0d2dd9689801675f6ff5b97c3dd13e3b8c...1.16) | Tinkers' Construct is a mod about putting tools together in a wide variety of ways, then modifying them until they turn into something else. The tools never disappear and can be named and changed to your heart's desire. Once you make them, they're yours forever. Many different materials can be used to make your tools. | ✔️ | ✔️ | ❌ |
...
| [Trash Cans](https://www.curseforge.com/minecraft/mc-mods/trash-cans) | 1.16.5/1.0.9 | | Trash Cans adds Trash Cans which can be used to void items, liquids and energy! Items and Liquids can be whitelisted or blacklisted and an energy transfer limit can be set! | ✔️ | ✔️ | ✔️ |
| [The Twilight Forest](https://www.curseforge.com/minecraft/mc-mods/the-twilight-forest) | [de9a3bf](https://github.com/TeamTwilight/twilightforest/tree/de9a3bf241552833b5dc5c77afaf9b6aff9851b1) | [Check](https://github.com/TeamTwilight/twilightforest/compare/de9a3bf241552833b5dc5c77afaf9b6aff9851b1...1.16.x) | Twilight Forest is a dimension exploration mod focused on adventure that will take you on a journey to meet strange creatures, exploring dungeons, and much more. | ✔️ | ❌ | ❌ |
| [Waystones](https://www.curseforge.com/minecraft/mc-mods/waystones) | 1.16.5/7.4.0 | | This mod adds waystone blocks that the player can return to once they've been activated, either through a Warp Scroll, a rechargeable Warp Stone, or by using an existing waystone to hop from one to the other. | ✔️ | ✔️ | ❌ |
